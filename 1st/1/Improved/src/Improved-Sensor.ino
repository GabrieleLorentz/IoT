#include <WiFi.h>
#include <esp_now.h>
#include <soc/soc.h> //libraries imported to store the variables during the deep sleep
...
RTC_DATA_ATTR int previous = -1;
RTC_DATA_ATTR int actual = -1;

// MAC receiver
uint8_t broadcastAddress[] = {0x8C, 0xAA, 0xB5, 0x84, 0xFB, 0x90};

const int SLEEP_TIME = 60000000; // ....... => deep sleep setted to 1 minute in improved version 
...
void setup() {
    ...
    if (previous != actual) {
        ...
        Serial.println("* SKIPPED COMMUNICATION: STATUS IS NOT CHANGED");
    }
